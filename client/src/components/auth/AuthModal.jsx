...
export default function AuthModal({ isOpen, onClose, isLogin, onAuthSuccess }) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Note: OAuth will redirect the user, so I don't need to handle success here
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          >
            ...
            : <>
                ...
                >
                  <path
                    d="M12.0003 4.75C14.0003 4.75 15.6823 5.456 16.9403 6.687L19.2633 4.364C17.4803 2.67 15.0253 1.75 12.0003 1.75C7.30033 1.75 3.22633 4.789 1.63733 9.078L4.54033 11.332C5.23433 9.429 6.86033 7.975 8.87833 7.375L12.0003 4.75Z"
                    fill="#EA4335"
                  />
                  <path
                    d="M22.2853 10.211H12.0003V14.289H18.5993C18.3583 15.524 17.6973 16.598 16.7023 17.382L19.6643 19.68C21.3283 18.211 22.2853 16.096 22.2853 13.579C22.2853 12.607 22.1273 11.66 21.8493 10.767L22.2853 10.211Z"
                    fill="#4285F4"
                  />
                  <path
                    d="M8.87833 17.625C6.86033 17.025 5.23433 15.571 4.54033 13.668L1.63733 15.922C3.22633 20.211 7.30033 23.25 12.0003 23.25C15.0253 23.25 17.4803 22.33 19.2633 20.636L16.9403 18.313C15.6823 19.544 14.0003 20.25 12.0003 20.25C9.99933 20.25 8.31733 19.544 7.05933 18.313L8.87833 17.625Z"
                    fill="#FBBC04"
                  />
                  <path
                    d="M4.54033 11.332L1.63733 9.078C1.40933 8.35 1.28533 7.575 1.28533 6.75C1.28533 6.186 1.34633 5.631 1.46433 5.092L4.54033 7.346C4.54033 7.346 5.23433 9.429 4.54033 11.332Z"
                    fill="#34A853"
                  />
                </svg>
                Sign in with Google
